...
set ylabel "Phi, DEG"
plot  \
   "GBS_3Out_PULSE.csv" using 1:51 title 'Phi' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "Theta, DEG"
plot  \
   "GBS_3Out_PULSE.csv" using 1:52 title 'Theta' with lines
...
set ylabel "Psi, DEG"
plot  \
   "GBS_3Out_PULSE.csv" using 1:53 title 'Psi' with lines
