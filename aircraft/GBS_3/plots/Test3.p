...
set ylabel "Phi, DEG"
plot  \
   "aircraft/GBS_3/results/GBS_3Testap.csv" using 1:51 title 'Roll' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "Theta, DEG"
plot  \
   "aircraft/GBS_3/results/GBS_3Testap.csv" using 1:52 title 'Pitch' with lines
...
plot  \
   "aircraft/GBS_3/results/GBS_3Testap.csv" using 1:50 title 'AGL' with lines
