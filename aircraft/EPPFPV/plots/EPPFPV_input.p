...
set ylabel "RAD"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_input.csv" using 1:48 title 'Roll-input' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "RAD"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_input.csv" using 1:47 title 'Pitch-input' with lines
...
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_input.csv" using 1:30 title 'Pitch-output' with lines , \
   "aircraft/EPPFPV/flightdata/criteria.txt" using 5:6 title 'Pitch-flight data' with lines
