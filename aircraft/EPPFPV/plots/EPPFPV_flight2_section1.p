...
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_section1.csv" using 1:29 title 'Roll' with lines
	
set origin 0.0,0.3
set xlabel ""
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_section1.csv" using 1:30 title 'Pitch' with lines
...
set ylabel "FT/SEC"
plot  \
	"aircraft/EPPFPV/results/EPPFPV_section1.csv" using 1:13 title 'Airspeed' with lines
