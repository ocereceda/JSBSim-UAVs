...
set ylabel "FT/SEC"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_static.csv" using 1:45 title 'Airspeed' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "FT"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_static.csv" using 1:28 title 'Altitude AGL' with lines
...
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_static.csv" using 1:30 title 'Pitch' with lines
