...
set ylabel "FT/SEC"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_ailerons3.csv" using 1:45 title 'Airspeed' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "FT"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_ailerons3.csv" using 1:33 title 'Beta' with lines
...
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_ailerons3.csv" using 1:29 title 'Roll' with lines
