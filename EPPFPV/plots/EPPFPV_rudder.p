...
set ylabel "FT/SEC"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_rudder.csv" using 1:45 title 'Airspeed' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "DEG/SEC"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_rudder.csv" using 1:4 title 'Yaw rate' with lines
...
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_rudder.csv" using 1:33 title 'Beta' with lines
