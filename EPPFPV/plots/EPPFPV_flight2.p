...
set ylabel "RAD"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_flight2.csv" using 1:29 title 'Roll' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "RAD"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_flight2.csv" using 1:30 title 'Pitch' with lines
...
set ylabel "DEG"
plot  \
	"aircraft/EPPFPV/results/EPPFPV_flight2.csv" using 1:13 title 'Airspeed' with lines
