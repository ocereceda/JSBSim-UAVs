...
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_DAA.csv" using 1:29 title 'Roll' with lines
	
set origin 0.0,0.3
set xlabel ""
set ylabel "DEG"
plot  \
   "aircraft/EPPFPV/results/EPPFPV_DAA.csv" using 1:30 title 'Pitch' with lines
...
set ylabel "FT"
plot  \
	"aircraft/EPPFPV/results/EPPFPV_DAA.csv" using 1:28 title 'Altitude' with lines
...
set ticslevel 0
splot \
	  "aircraft/EPPFPV/results/EPPFPV_DAA.csv" using 35:34:28 title 'Trajectory' with lines
