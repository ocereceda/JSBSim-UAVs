...
set ylabel "Phi, DEG"
plot  \
   "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 1:104 title 'Roll' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "Theta, DEG"
plot  \
   "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 1:105 title 'Pitch' with lines
...
plot  \
   "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 1:103 title 'AGL' with lines
...
plot  \
   "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 1:131 title 'Distance' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "Heading, DEG"
plot  \
   "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 1:134 title 'Heading' with lines
...
plot  \
   "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 1:258 title 'Airspeed' with lines
...
set ticslevel 0
splot \
	  "aircraft/DHC6/test/IdentificationDHC6_Out.csv" using 110:257:103 title 'Trajectory' with lines
