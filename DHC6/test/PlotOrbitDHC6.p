...
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:258 title 'Airspeed' with lines
...
set ticslevel 0
splot \
	  "aircraft/DHC6/test/TestDHC6_Out.csv" using 110:257:103 title 'Trajectory' with lines
