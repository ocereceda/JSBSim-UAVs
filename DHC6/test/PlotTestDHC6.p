...
set ylabel "Phi, DEG"
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:104 title 'Roll' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "Theta, DEG"
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:105 title 'Pitch' with lines
...
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:103 title 'AGL' with lines
...
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:131 title 'Distance' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "Heading, DEG"
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:134 title 'Heading' with lines

#set origin 0.0,0.03
set origin 0.0,0.0
set xlabel "Time, sec"
set ylabel "Airspeed, FT/SEC"
plot  \
   "aircraft/DHC6/test/TestDHC6_Out.csv" using 1:22 title 'Airspeed' with lines
...
set zlabel "Alt, FT"
set ticslevel 0
splot "aircraft/c172x/test/TestC172_Out.csv" using 110:255:103 title 'Trajectory 1' with lines , \
	  "aircraft/DHC6/test/TestDHC6_Out.csv" using 110:268:103 title 'Trajectory 2' with lines
