...
set ylabel "FT/SEC"
plot  \
   "GBS_3Out_rudder.csv" using 1:24 title 'UBody' with lines

set origin 0.0,0.3
set xlabel ""
set ylabel "FT/SEC"
plot  \
   "GBS_3Out_rudder.csv" using 1:25 title 'VBody' with lines
...
set ylabel "FT/SEC"
plot  \
   "GBS_3Out_rudder.csv" using 1:26 title 'WBody' with lines
